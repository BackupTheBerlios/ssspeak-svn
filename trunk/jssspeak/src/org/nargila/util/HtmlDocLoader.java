...
/**
 * HTML document loader. Input HTML is passed through Tidy to make it XML compliant first.
 * @author tshalif
 *
 */
public class HtmlDocLoader {
    ...
    /**
     * Add id's to any '///a' element with an @href
     */
    ...
    /**
     * Force creation of an 'a' element with id before a referenced target
     * @param html input node
     * @param name target name
     * @param id id to attach to the created 'a' element
     * @return
     * @throws Exception
     */
